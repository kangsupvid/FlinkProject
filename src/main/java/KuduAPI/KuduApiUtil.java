...
public class KuduApiUtil {
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(KuduApiUtil.class);
    private static  String master;
    private static  String tableName;
    private static  KuduClient client;


    public KuduApiUtil(String master,String tableName){
        this.master = master;
